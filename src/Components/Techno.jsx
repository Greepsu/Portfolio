      ...
      <div className="techno-list">
        ...
        <div className="techno-list-container">
            <ul>
                ...
                <li><span>05</span>Node.js</li>
            </ul>
            <ul>
                <li><span>06</span>Mongo Db</li>
                <li><span>07</span>React js</li>
                <li><span>08</span>Next js</li>
                <li><span>09</span>Github</li>
                <li><span>10</span>Figma</li>
            </ul>
        </div>
